...
class User(BaseModel, db.Model):
    ...
    def password(self):
        ...
        raise AttributeError(u"这个属性只能设置，不能读取")

    @password.setter
    def password(self, value):
        """设置属性的函数行为
        :param value: 设置属性时的数据, 原始的明文密码
        """
    ...
    def to_dict(self):
        ...
        user_dict = {
            ...
            "name": self.name,
            "mobile": self.mobile,
            "avatar": constants.FDFS_URL_DOMAIN + self.avatar_url if self.avatar_url else "",
...
class House(BaseModel, db.Model):
    ...
    def to_basic_dict(self):
        ...
        house_dict = {
            ...
            "img_url": constants.FDFS_URL_DOMAIN + self.index_image_url if self.index_image_url else "",
            "room_count": self.room_count,
            "order_count": self.order_count,
            "address": self.address,
            "user_avatar": constants.FDFS_URL_DOMAIN + self.user.avatar_url if self.user.avatar_url else "",
    ...
    def to_full_dict(self):
        ...
        for image in self.images:
            img_urls.append(constants.FDFS_URL_DOMAIN + image.url)
...
class Order(BaseModel, db.Model):
    ...
    def to_dict(self):
        ...
        order_dict = {
            ...
            "img_url": constants.FDFS_URL_DOMAIN + self.house.index_image_url if self.house.index_image_url else "",
